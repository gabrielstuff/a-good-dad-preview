<?php
/*
Plugin Name: Easy imgur.com post images
Plugin URI: http://www.tinyplugins.com
Description: Allows you to upload images to imgur.com directly from your posting screen.
Version: 1.0
Author: Chris McCoy
...
function imgur_add_tab($tabs) {
	$tabs['imgur'] = __("imgur.com Uploader","imgur");
	return $tabs;
}
